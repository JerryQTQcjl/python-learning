...
def func_with_fix_keyword_param(param1, *, param2, param3):
    print(f'exec func_with_fix_keyword_param({param1}, {param2}, {param3})')
...
if __name__ == "__main__":
    ...
    # 显式指明参数类型和返回值类型
    print(
        f"func_with_obvious_type(1, '2', '1', '2', '3', param4=[1, 2, 3], param5='', param6='a'), return: {func_with_obvious_type(1, '2', '1', '2', '3', param4=[1, 2, 3], param5='', param6='a')}")
    # 多返回值
    print(f'func_with_multi_return(), return: {func_with_multi_return()}')